...
# from langfuse.decorators import langfuse_context  # Disabled to bypass Langfuse error

from src.config import settings  # Changed from src.config.settings to src.config
...
from src.utils import (
    init_langfuse,  # Still imported but won't be called
    setup_custom_logger,
)
...
async def lifespan(app: FastAPI):
    ...
    # init_langfuse(settings)  # Disabled to bypass Langfuse

    yield

    # shutdown events
    # langfuse_context.flush()  # Disabled to bypass Langfuse
